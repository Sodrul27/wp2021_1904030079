                ...
                <tbody>
                    ...
                    <?php foreach ($camaba as $mhs) : ?>
                        <tr>
                            ...
                            <td><a href="detail.php?id=<?= $mhs["id"] ?>" class="btn btn-outline-warning"><i class="fas fa-edit"></i></a> || <a href="hapus.php?id=<?= $mhs['id']; ?>" class="btn btn-outline-danger"><i class="fas fa-trash"></i></a></td>
                        </tr>
                        <?php $no++ ?>
                    <?php endforeach ?>
                </tbody>
