        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <div class="container-fluid">
                <form class="d-flex" action="" method="POST">
                    <input class="form-control me-2" type="text" placeholder="Search" id="keyword" aria-label="Search" name="keyword">
                ...
                <tbody>
                    ...
                    <?php foreach ($camaba as $mhs) : ?>
                        <tr>
                            ...
                            <td><a href="detail.php?id=<?= $mhs["id"] ?>" class="btn btn-outline-warning"><i class="fas fa-edit"></i></a> || <a href="hapus.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data?')" class="btn btn-outline-danger"><i class="fas fa-trash"></i></a></td>
                        </tr>
                        <?php $no++ ?>
                    <?php endforeach ?>
                </tbody>
