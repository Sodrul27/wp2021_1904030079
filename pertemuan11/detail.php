        ...
        <div class="col-md-10 p-5 pt-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-2">
                            <img src="image/<?= $camaba["foto_maba"] ?>" class="card-img-top" alt="..." style="max-width: 100px;">
                        </div>
                        <div class="col-2">
                    ...
                    <div class="mt-2 d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="edit.php?id=<?= $camaba["id"] ?>" class="btn btn-primary">Edit</a>
                        <a href="hapus.php?id=<?= $camaba["id"] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-danger">Hapus</a>
